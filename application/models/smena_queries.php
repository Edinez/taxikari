...
class smena_queries extends CI_Model
{
    ...
    public function getSmenyVsetky2(){
        $this->db->select('smeny.idSmeny , smeny.Datum_Od , smeny.Datum_Do , smeny.Cas_Od , smeny.Cas_Do , vodic.Meno as vodicmeno , vodic.Priezvisko as vodicpriezvisko , vozidlo.Znacka as znacka , vozidlo.Model as model');
        $this->db->from('smeny');
